...
from EventStream.EventStreamData.event_stream_dataset_polars import EventStreamDataset
from EventStream.EventStreamData.types import (
    DataModality,
    TemporalityType,
    NumericDataModalitySubtype,
)
from EventStream.EventStreamData.time_dependent_functor import TimeDependentFunctor
...
class TestESD(EventStreamDataset):
    PREPROCESSORS = {
...
in_event_subjects = {
    1: 1, 2: 1, 3: 2, 4: 2, 5: 1, 6: 2, 7: 1, 8: 1, 9: 1, 10: 2, 11: 2, 12: 3, 13: 3, 14: 3, 15: 3,
}
...
IN_MEASUREMENTS_DF = pl.DataFrame(
    data={
        ...
        'dynamic_preset_vocab': [
            *([None]*17),
            *([None]*4),
            'foo', 'foo', 'bar', 'bar', 'bar', 'baz', 'baz', 'foo', 'foo',
        ],
        ...
        'multivariate_regression_bounded_outliers': [
            'mrbo1', 'mrbo3', 'mrbo2', 'mrbo1',
            'mrbo2', 'mrbo1', 'mrbo3', 'mrbo2',
            'mrbo3', 'mrbo2', 'mrbo1', 'mrbo3',
            None, None, None, None,
            None,
            *([None]*4),
            *([None]*9),
        ...
        # Has pre-set keys wth value types as follows:
        #          Value Type
        ...
        'multivariate_regression_preset_value_type': [
            ...
            'pvt_int', 'pvt_cat_int',
            'pvt_added', 'pvt_flt',
            'pvt_cat_int', 'pvt_drp', 'pvt_cat_flt', 'pvt_cat_int',

            # Event ID 2
            'pvt_cat_flt', 'pvt_int', 'pvt_cat_int', 'pvt_cat_flt',
            'pvt_drp', 'pvt_cat_flt',
            'pvt_flt', 'pvt_added',
            None,
        ...
        'multivariate_regression_no_preset': [
            # Event ID 1
            'mrnp_dropped', 'mrnp_flt', 'mrnp_flt',
            'mrnp_key_dropped', 'mrnp_int', 'mrnp_int',
            'mrnp_cat_int', 'mrnp_cat_int',

            # Event ID 2
            'mrnp_cat_int', 'mrnp_cat_int', 'mrnp_cat_int', 'mrnp_cat_int',
            'mrnp_cat_int', 'mrnp_cat_int',
            'mrnp_flt', 'mrnp_dropped',
            'mrnp_int',
...
WANT_INFERRED_MEASUREMENT_CONFIGS = {
    ...
    'time_dependent_age_lt_90': MeasurementConfig(
        ...
        measurement_metadata = pd.Series(
            [
                90, False,
                NumericDataModalitySubtype.FLOAT, {'mean': outlier_mean_lt_90}, {'min': normalizer_min_lt_90}
            ],
            index=pd.Index([
                'drop_upper_bound', 'drop_upper_bound_inclusive', 'value_type', 'outlier_model', 'normalizer'
            ]),
            name='time_dependent_age_lt_90',
        ),
        observation_frequency = 1,
    ...
    'multivariate_regression_preset_value_type': MeasurementConfig(
        ...
        vocabulary = Vocabulary(
            [
                ...
                'pvt_cat_int__EQ_2', 'pvt_drp', 'pvt_flt', 'pvt_int'
            ], [0, 1, 1, 1, 1, 1, 1, 1, 1]
        ),
    ),
    'multivariate_regression_no_preset': MeasurementConfig(
        ...
        vocabulary = Vocabulary(
            [
                ...
                'mrnp_cat_int__EQ_2', 'mrnp_dropped'
            ],
            [3, 3, 3, 2, 2, 2, 2]
        ),
        measurement_metadata = pd.DataFrame(
...
WANT_UNIFIED_VOCABULARY_IDXMAP = {
    ...
    **{
        kk: {
            k: i+WANT_UNIFIED_VOCABULARY_OFFSETS[kk] for i, k in enumerate(
                WANT_INFERRED_MEASUREMENT_CONFIGS[kk].vocabulary.vocabulary
            )
        } for kk in (
            'dynamic_preset_vocab', 'multivariate_regression_bounded_outliers',
...
WANT_EVENTS_DF = pl.DataFrame(
    data={
        ...
        'event_type': [
            'MVR', 'DDIC', 'DPV', 'DPV', 'DPV', 'MVR', 'DDIC', 'DPV', 'DPV', 'DPV', 'DPV', 'DPV', 'DPV'
        ],
...
WANT_MEASUREMENTS_DF = pl.DataFrame(
    data={
        ...
        'dynamic_preset_vocab': [
            *([None]*17),
            *([None]*4),
            'foo', 'foo', 'bar', 'bar', 'bar', 'UNK', 'UNK', 'foo', 'foo',
        ],
        ...
        # Also has extra key not in the pre-set of 'pvt_added'
        'multivariate_regression_preset_value_type': [
            'pvt_int', 'pvt_cat_int__EQ_2',
            'pvt_added', 'pvt_flt',
            'pvt_cat_int__EQ_1', 'pvt_drp', 'pvt_cat_flt__EQ_1.0', 'pvt_cat_int__EQ_2',
            'pvt_cat_flt__EQ_1.0', 'pvt_int', 'pvt_cat_int__EQ_1', 'pvt_cat_flt__EQ_2.0',
            'pvt_drp', 'pvt_cat_flt__EQ_2.0',
            'pvt_flt', 'pvt_added',
            None,
            *([None]*4),
            *([None]*9),
        ...
        'multivariate_regression_no_preset': [
            'mrnp_dropped', 'mrnp_flt', 'mrnp_flt',
            'UNK', 'mrnp_int', 'mrnp_int',
            'mrnp_cat_int__EQ_1', 'mrnp_cat_int__EQ_1',

            'mrnp_cat_int__EQ_2', 'mrnp_cat_int__EQ_2',
            'mrnp_cat_int__EQ_3', 'mrnp_cat_int__EQ_3', 'UNK', 'UNK',
            'mrnp_flt', 'mrnp_dropped',
            'mrnp_int',
            *([None]*4),
            *([None]*9),
        ...
        'dynamic_indices': [
            [
                [
                    ...
                    WANT_UNIFIED_VOCABULARY_IDXMAP['multivariate_regression_preset_value_type']['pvt_cat_int__EQ_2'],
                    ...
                    WANT_UNIFIED_VOCABULARY_IDXMAP['multivariate_regression_preset_value_type']['pvt_cat_int__EQ_1'],
                    ...
                    WANT_UNIFIED_VOCABULARY_IDXMAP['multivariate_regression_preset_value_type']['pvt_cat_flt__EQ_1.0'],
                ...
                [
                    ...
                    WANT_UNIFIED_VOCABULARY_IDXMAP['multivariate_regression_bounded_outliers']['mrbo3'],
                    WANT_UNIFIED_VOCABULARY_IDXMAP['multivariate_regression_no_preset']['mrnp_cat_int__EQ_3'],
                    WANT_UNIFIED_VOCABULARY_IDXMAP['multivariate_regression_preset_value_type']['pvt_cat_flt__EQ_2.0'],
...
class TestEventStreamDatasetEndToEnd(ConfigComparisonsMixin, unittest.TestCase):
    def test_end_to_end(self):
        ...
        with self.subTest("Save/load should work"):
            with TemporaryDirectory() as d:
                ...
                got_E = EventStreamDataset._load(save_dir)
                ...
                self.assertNestedDictEqual(WANT_INFERRED_MEASUREMENT_CONFIGS, got_E.inferred_measurement_configs)
