...
from .model_output import EventStreamTransformerOutputWithPast
...
class InnerSelfAttention(nn.Module):
    def __init__(
        self, config: StructuredEventStreamTransformerConfig, attention_type: str, window_size: int,
    ):
        super().__init__()
...
class InnerAttention(nn.Module):
    def __init__(
        self, config: StructuredEventStreamTransformerConfig, layer_id: int = 0, is_seq: bool = True
    ):
        super().__init__()
...
class InnerBlock(nn.Module):
    def __init__(self, config: StructuredEventStreamTransformerConfig, layer_id: int, is_seq: bool):
        super().__init__()
...
class StructuredEventStreamTransformerBlock(nn.Module):
    def __init__(self, config: StructuredEventStreamTransformerConfig, layer_id: int):
        super().__init__()
...
class StructuredEventStreamTransformerPreTrainedModel(PreTrainedModel):
    """
    The pre-trained model class for EventStreamTransformer models.
    """

    config_class = StructuredEventStreamTransformerConfig
    base_model_prefix = "transformer"
    supports_gradient_checkpointing = True
    _no_split_modules = ["StructuredEventStreamTransformerBlock"]
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, StructuredEventStreamTransformer):
...
class StructuredEventStreamInputLayer(torch.nn.Module):
    """
...
class StructuredEventStreamTransformer(StructuredEventStreamTransformerPreTrainedModel):
    def __init__(self, config: StructuredEventStreamTransformerConfig):
        super().__init__(config)

        self.embed_dim = config.hidden_size
        self.input_layer = StructuredEventStreamInputLayer(config)
    ...
    def forward(
    ...
    ) -> Union[Tuple[torch.Tensor], EventStreamTransformerOutputWithPast]:
        output_attentions = (
        ...
        return EventStreamTransformerOutputWithPast(
