...
class StructuredEventStreamGenerationMixin:
    ...
    def _expand_inputs_for_generation(
        ...
        expand_size: int = 1,
        **model_kwargs,
    ) -> Tuple[EventStreamPytorchBatch, Dict[str, Any]]:
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        Generates continuous-time sequences of events for models with an EventStream Generation head. The
    ...
    def greedy_search(self, *args, **kwargs) -> Union[GreedySearchOutput, EventStreamPytorchBatch]:
        return self._search(*args, **kwargs, sample_fn = 'greedy')

    def sample(self, *args, **kwargs) -> Union[SampleOutput, EventStreamPytorchBatch]:
