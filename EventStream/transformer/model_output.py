...
from .config import StructuredTransformerConfig, MEAS_INDEX_GROUP_T
from ..data.types import TemporalityType, DataModality, PytorchBatch
...
class GenerativeSequenceModelSamples(ModelOutput):
    ...
    def append_to_batch(
        self, batch: PytorchBatch, config: StructuredTransformerConfig,
        base_dataset: Optional[DatasetBase] = None,
        batch_schema: Optional[List[Tuple[int, datetime, datetime]]] = None,
        static_data: Optional[pd.DataFrame] = None,
    ) -> PytorchBatch:
